...
function SmallCoreValues() {
  ...
  return (
    <div className="flex h-1/2 flex-col items-center justify-end  mt-5 px-5  ">
      <div className="max-w-5xl flex flex-col items-start rounded-xl bg-slate-100 dark:bg-slate-300  bg-opacity-50 dark:bg-opacity-10 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:gap-9 md:p-10 ">
        {values.map((service, index) => (
          <div key={index} className="bg-slate-100 dark:bg-slate-300  bg-opacity-50 dark:bg-opacity-10 rounded-xl" >
