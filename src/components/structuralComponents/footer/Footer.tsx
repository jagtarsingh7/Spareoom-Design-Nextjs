...
<footer className=" dark:text-slate-100 text-black ">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm sm:text-center ">© 2023 <a href="https://Spareöom.com/" className="hover:underline">Spareöom™</a>. All Rights Reserved.
          </span>
